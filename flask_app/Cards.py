...
def is_card(contour):
    ...
    return (size < CARD_MAX_AREA) and (size > CARD_MIN_AREA) and (len(approx) == 4)
...
def draw_results(image, qCard):
    ...
    # Log the card name being drawn
    print(f"Drawing card: {rank_name} of {suit_name} at position ({x}, {y})")
